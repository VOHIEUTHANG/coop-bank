...
exports.IndividualModule = IndividualModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([individual_entity_1.Individual]), users_module_1.UsersModule, affiliate_unit_module_1.AffiliateUnitModule],
        controllers: [individual_controller_1.IndividualController],
        providers: [individual_service_1.IndividualService, file_helper_1.FileService]
    })
], IndividualModule);
