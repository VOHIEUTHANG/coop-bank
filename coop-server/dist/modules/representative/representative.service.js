...
let RepresentativeService = class RepresentativeService {
    ...
    async create(createData, user_id) {
        ...
        createData.effective_date_to = (0, date_util_1.transformDate)(createData.effective_date_to);
        createData.effective_date_from = (0, date_util_1.transformDate)(createData.effective_date_from);
        createData.decision_date = (0, date_util_1.transformDate)(createData.decision_date);
        ...
        createData.representative_id = (0, string_util_1.generateId)();
    ...
    async findOne(representative_id) {
    ...
    async update(updateData) {
        ...
        updateData.effective_date_to = (0, date_util_1.transformDate)(updateData.effective_date_to);
        updateData.effective_date_from = (0, date_util_1.transformDate)(updateData.effective_date_from);
        updateData.decision_date = (0, date_util_1.transformDate)(updateData.decision_date);
...
exports.RepresentativeService = RepresentativeService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_2.InjectRepository)(representative_entity_1.Representative)),
